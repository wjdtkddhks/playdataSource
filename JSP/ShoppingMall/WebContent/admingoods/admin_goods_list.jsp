...
<body>
<table width="960" cellspacing="0" cellpadding="0" border="0" bordercolor="gray" align="center">
	<tr>
		<td colspan=2>
		<!-- 상품 목록 -->
		<table border="0" width="80%">
			...
			<tr>
				...
				<p align="right">
					<font size=2>
					<a href="./MemberModifyAction_1.me">관리자정보수정</a>
					&nbsp;&nbsp;|&nbsp;&nbsp;<a href="./AdminOrderList.ao">고객주문 상품리스트</a>
