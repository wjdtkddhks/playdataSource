...
<table border=0 cellspacing=1 cellpadding=0 width=80%>
	...
	<td style=font-family:Tahoma;font-size:8pt;>
   	...
   	<td style=font-family:Tahoma;font-size:8pt;><%=sdf.format(order.getORDER_DATE()) %></td>
   	<td style=font-family:Tahoma;font-size:8pt;>
   	<a href="./AdminOrderDetail.ao?order_num=<%=order.getORDER_NUM() %>">
   	Modify</a>/
   	<a href="./AdminOrderDelete.ao?order_num=<%=order.getORDER_NUM() %>" 
