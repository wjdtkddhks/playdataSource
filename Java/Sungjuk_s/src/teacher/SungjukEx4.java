...
public static void main(String[] args) 
{
	...
	static void search_sungjuk(ArrayList<Sungjuk> sun, Scanner as)
	{	Sungjuk obj =null;
	...
	static void change_sungjuk(ArrayList<Sungjuk> sun, Scanner as)
	{
		Sungjuk obj = null;
		System.out.print("학번입력 => ");
		String hakbun = as.next();
	...
	static int delete_sungjuk(ArrayList<Sungjuk> sun, int cnt, Scanner as)
	{
		Sungjuk obj = null;
		System.out.print("학번입력 => ");
		String hakbun = as.next();
